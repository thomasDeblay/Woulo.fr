...
function isInViewport(element) {
    ...
    return rect.top >= 0 && rect.top <= (window.innerHeight || html.clientHeight) && rect.left >= 0 && rect.right <= (window.innerWidth || html.clientWidth);
}
...
var _isInViewport = __webpack_require__(5);
...
var FadeImage = function (_Component) {
    ...
    _createClass(FadeImage, null, [{
        ...
        get: function get() {
            return {
                ...
                loaderComponent: _propTypes2.default.element
            };
        }
    }, {
        key: 'defaultProps',
    ...
    function FadeImage(props) {
        ...
        _this.scrollHandler = (0, _lodash2.default)(_this.scrollHandler.bind(_this), 200, { leading: true });
        _this.state = {
            src: _this.props.src,
            isLoaded: false
        };
    ...
    _createClass(FadeImage, [{
        ...
        value: function scrollHandler() {
            if ((0, _isInViewport2.default)(this.refs.container) && !this.state.loaded) {
        ...
        value: function render() {
            ...
            //console.log("Render!");
            var imageClasses = [_index2.default.fadeImg];
            var loaded = this.state.isLoaded ? _index2.default.loaded : null;
            ...
            if (this.props.ratio) {
                ...
                width = _props$ratio$split2[0];
                height = _props$ratio$split2[1];
            ...
            return _react2.default.createElement(
                'div',
                { ref: 'container', className: _index2.default.container, style: theStyle },
                this.state.isLoaded ? null : this.props.loaderComponent,
                _react2.default.createElement('img', { ref: function ref(image) {
                        return _this2.imageElement = image;
...
// module
exports.push([module.i, ".index_55d {\n    position: relative;\n    display: block;\n    height: 0;\n    background: transparent;\n}\n\n.index_749 {\n    margin: 0;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n}\n\n.index_fa0 {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    border: 0;\n    opacity: 0;\n    transition: opacity 300ms, 300ms filter linear; \n}\n\n.index_fa0.index_603 {\n    opacity: 1;\n}", ""]);
